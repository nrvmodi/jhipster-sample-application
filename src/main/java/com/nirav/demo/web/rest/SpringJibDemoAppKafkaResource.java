...
@RestController
@RequestMapping("/api/spring-jib-demo-app-kafka")
public class SpringJibDemoAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SpringJibDemoAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SpringJibDemoAppKafkaResource(KafkaProperties kafkaProperties) {
